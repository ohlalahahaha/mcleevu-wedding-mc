  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="story-band" id="about" aria-labelledby="about-title">
        <div className="about-panel"><div className="section-copy"><h2 id="about-title">{t.aboutTitle}</h2><p>{t.aboutBody}</p></div><div className="about-portrait-composition"><figure className="about-photo about-photo-primary"><img src="/media/lee-vu-portrait-navy.jpg" alt={realPhotoAlt} loading="lazy"/></figure><figure className="about-photo-inset"><img src="/media/lee-vu-portrait-blue.jpg" alt="" loading="lazy"/></figure></div></div>
